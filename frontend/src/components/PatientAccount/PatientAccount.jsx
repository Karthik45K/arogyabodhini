...
const PatientAccount = ({ onClose, onAuthenticated, initialMode = 'login', initialView = 'profile', showVideoPrompt = false, onJoinVideoRoom }) => {
  ...
  if (!patient) {
    ...
    return typeof document !== 'undefined' ? createPortal(authModal, document.body) : authModal
  }
  ...
  return typeof document !== 'undefined' ? createPortal(accountModal, document.body) : accountModal
}
